        ...
        <el-table-column label="操作">
          ...
          <el-dialog title="患者预约信息" :visible.sync="dialogTableVisible">
            <el-descriptions direction="vertical" :column="4" border>
              <el-descriptions-item label="预约日期">2021-05-02</el-descriptions-item>
              <el-descriptions-item label="预约时间">男</el-descriptions-item>
              <el-descriptions-item label="姓名">15:00</el-descriptions-item>
              ...
              <el-descriptions-item label="血压">AAA</el-descriptions-item>
              <el-descriptions-item label="心率">AAA</el-descriptions-item>
