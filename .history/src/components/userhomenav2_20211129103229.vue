  ...
  <div class="container">
    <div class="head">
      ...
      <div class="headmain">
        ...
        <div>
          <el-button type="primary" @click="returnhome">资格认证</el-button>
        </div>
        <div>
          <el-button type="info" style="margin-left:30px" @click="returnhome">返回首页</el-button>
        </div>
      </div>
    </div>
    <div class="navBar">
