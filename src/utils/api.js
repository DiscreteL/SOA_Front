...
export default {
  ...
  //  diseaseList (data) {
  //    return instance.get("https://api.apishop.net/common/disease/queryDiseaseList?apiKey=GqvbYer04485869e6b5acbed4ed10dfd79468f6d84577b1&page=1&pageSize=4", data);
  //  },
  //  diseaseInfo(data){
